...
namespace :styleguide do
  ...
  def compile_stylesheets
    `bundle exec sass --load-path blue/stylesheets --load-path bower_components --require font-awesome-sass source/stylesheets/all.scss`
  end

  def styleguide_command(style_source, output_folder, watch)
    kss_sources = ['source/stylesheets/**/*.scss', 'blue/stylesheets/blue/**/*.scss']
    options = [
